...
const SearchServicesTab = ({
  ...
  return (
    <div className="content-inner slide-in">
      ...
      >
        <div className="search-filters-row" style={{ display: 'flex', gap: '15px', flexWrap: 'wrap' }}>
          <div className="search-filter-item" style={{ flex: '1 1 200px' }}>
            <label style={{ fontSize: '0.8rem', fontWeight: 'bold', color: 'var(--primary)', marginBottom: '5px', display: 'block' }}>Service Category</label>
            <input
              type="text"
          ...
          <div className="search-filter-item" style={{ flex: '1 1 200px' }}>
            <label style={{ fontSize: '0.8rem', fontWeight: 'bold', color: 'var(--primary)', marginBottom: '5px', display: 'block' }}>Location</label>
            <input
              type="text"
              className="styled-input"
          ...
          <div className="search-filter-item search-filter-wide" style={{ flex: '2 1 300px' }}>
            <label style={{ fontSize: '0.8rem', fontWeight: 'bold', color: 'var(--primary)', marginBottom: '5px', display: 'block' }}>Quick Search</label>
            <div className="search-input-inline" style={{ display: 'flex', alignItems: 'center', background: '#f5f7fa', borderRadius: '8px', padding: '0 10px', border: '1px solid #ddd' }}>
      ...
      >
        {filteredWorkers
          ...
          .map((w) => (
            <div key={w._id} className="worker-card-slim card-pro animate-fade-in-up">
              ...
              <div className="worker-stats-row">
                <span>
                  <i className="fas fa-star" style={{ color: "#fbc02d" }}></i> 5.0
                </span>
                <span>
                  <i className="fas fa-user-clock" style={{ color: "var(--accent)" }}></i>{" "}
                  {w.workerDetails?.experience} Yrs
                </span>
              </div>
              <div className="worker-location-row" style={{ marginTop: '10px' }}>
